...
import com.blog.common.core.exception.ValidateCodeException;
...
public class ValidateCodeGatewayFilter extends AbstractGatewayFilterFactory<Object> {
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            boolean isIgnoreClient = configProperties.getIgnoreClients().contains(DiyWebUtil.getClientId(request));
            try {
