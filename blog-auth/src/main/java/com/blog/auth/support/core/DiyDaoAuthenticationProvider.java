package com.blog.auth.support.core;
...
public class DiyDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        // app 模式不用校验密码
        String grantType = DiyWebUtil.getRequest().get().getParameter(OAuth2ParameterNames.GRANT_TYPE);
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        ...
        HttpServletRequest request = DiyWebUtil.getRequest()
                .orElseThrow((Supplier<Throwable>) () ->
                                new InternalAuthenticationServiceException("web request is empty"));
